(function() {
  ...
  module.factory('ParseAuth', function(persist, ParseUser, ParseUtils, $q) {
    ...
    return auth = {
      ...
      update: function(username, password, email, name, aboutme, objectId) {
        return new ParseUser({
          username: username,
          password: password,
          email: email,
      ...
      updatePicuture: function(profilePicture, objectId) {
        return new ParseUser({
  ...
  module.factory('ParseDefaultUser', function(ParseModel) {
    ...
    return User = (function(_super) {
      ...
      User.configure('users', 'username', 'password', 'email', 'aboutme', 'name', 'profilePicture');
      ...
      User.prototype.save = function() {
        var _this = this;
        //console.log("casper" + JSON.stringify(this));
